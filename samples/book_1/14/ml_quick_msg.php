...
<html>
  ...
  <body>
    ...
    <form method="post" action="ml_admin_transact.php">
      <table>
        <tr>
          <td><label for="ml_id">Distribuèní seznam:</label></td>
          ...
          <td><label for="subject">Pøedmìt:</label></td>
          ...
          <td> </td>
          <td><input type="submit" name="action" value="Odeslat zprávu"/></td>
        </tr><tr>
      </table>
    </form>
    <p><a href="ml_admin.php">Zpìt na správu distribuèních seznamù.</a></p>
  </body>
</html>