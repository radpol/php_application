...
if ($numrows == 0) {
  ...
  $title = 'Diskusní fórum: ' . $forum['name'];
...
<tr>
  <th style="width: 50%;">Konverzace</th>
  <th>Autor</th>
  <th>Odpovìdi</th>
  <th>Poslední pøíspìvek</th>
</tr>
<?php
$rowclass = '';
