...
if (empty($user_id)) {
  echo '<h1>Vytvoøit úèet</h1>';
} else {
  echo '<h1>Upravit úèet</h1>';
}
?>
<form method="post" action="cms_transact_user.php">
  <table>
    ...
    {
      echo '<tr><td>Úroveò pøístupu</td><td>';
    ...
    <tr>
      ...
      <td><label for="password_2">Heslo (ještì jednou):</label></td>
      ...
      <td> </td>
      <td>
        <input type="submit" name="action" value="Vytvoøit úèet"/>
      </td>
    </tr>
    <?php
  } else {
