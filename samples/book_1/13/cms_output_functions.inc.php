<?php
// Vrátí øetìzec zkrácený na urèený poèet znakù. Bude-li øetìzec zkrácen,
// pøipojí funkce na konec øetìzce obsah promìnné $tail.
...
function show_comments($db, $article_id, $show_link = TRUE) {
  ...
  if ($show_link) {
    echo '<h3>' . mysql_num_rows($result) . ' - Komentáøe';
...
function datum($format_string, $date){
  ...
  $cz = array("ledna", "února", "bøezna", "dubna", "kvìtna", "èervna",
