...
if (isset($_POST['submit']) && $_POST['submit'] == 'Upravit') {
  ...
  // Odstranìní uživatelského záznamu.
  if (isset($_POST['delete'])) {
    ...
    <html>
      ...
      <body>
        <p><strong>Úèet byl vymazán.</strong></p>
        <p><a href="admin_area.php">Klepnìte sem</a> pro návrat.</p>
      </body>
    </html>
    <?php
    die();
  ...
  if (mysql_num_rows($result) > 0) {
    $errors[] = 'Uživatelské jméno ' . $username . ' je již registrováno.';
    $username = '';
  }
  ...
  if (count($errors) > 0) {
    echo '<p><strong style="color:#FF000;">Aktualizaci nelze dokonèit.' .
    '</strong></p>';
  ...
  <form action="update_user.php" method="post">
    <table>
      <tr>
        ...
        <small>(Nemìníte-li heslo, nechte políèko prázdné.)</small></td>
      </tr><tr>
